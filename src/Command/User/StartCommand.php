...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= '<b>' . __('Привет!') . '</b>' . PHP_EOL;
        $text .= __('Рады видеть вас снова!

👋 Выберите игру и бросьте вызов друзьям! 💪', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
